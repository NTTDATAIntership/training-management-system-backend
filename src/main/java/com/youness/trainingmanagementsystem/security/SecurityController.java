...
public class SecurityController {
    ...
    public ResponseEntity<String> registerUser(@RequestBody RegisterRequest request) {
        ...
        if (request.getRole() == Role.ROLE_EMPLOYEE) {
            user = registrationService.registerEmployee(request.getEmail(), request.getPassword(), request.getRole());
        } else if (request.getRole() == Role.ROLE_MANAGER) {
            user = registrationService.registerManager(request.getEmail(), request.getPassword(), request.getRole());
        } else if (request.getRole() == Role.ROLE_TEAM_LEADER) {
            user = registrationService.registerTeamLeader(request.getEmail(), request.getPassword(), request.getRole());
        } else{
            user = registrationService.registerUser(request.getEmail(), request.getPassword(), request.getRole());
